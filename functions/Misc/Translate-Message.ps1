function Translate-Message {
    ...
    $translations = @{
        "en" = @{
            ...
            "GptTranslateStart" = "Translation of $sourceLanguageName to $targetLanguageName subtitles started using GPT."
        ...
        "da" = @{
            ...
            "GptTranslateStart" = "Oversættelse af $sourceLanguageName til $targetLanguageName undertekster startet ved brug af GPT."
        ...
        "de" = @{
            ...
            "GptTranslateStart" = "Übersetzung der $sourceLanguageName zu $targetLanguageName Untertitel gestartet mit GPT."
        ...
        "no" = @{
            ...
            "GptTranslateStart" = "Oversettelse av $sourceLanguageName til $targetLanguageName undertekster startet med GPT."
        ...
        "sv" = @{
            ...
            "GptTranslateStart" = "Översättning av $sourceLanguageName till $targetLanguageName undertexter startad med GPT."
        ...
        "es" = @{
            ...
            "GptTranslateStart" = "Traducción de subtítulos de $sourceLanguageName a $targetLanguageName iniciada usando GPT."
        ...
        "fr" = @{
            ...
            "GptTranslateStart" = "Traduction des sous-titres de $sourceLanguageName en $targetLanguageName commencée avec GPT."
        ...
        "bg" = @{
            ...
            "GptTranslateStart" = "Преводът на субтитрите от $sourceLanguageName на $targetLanguageName започна чрез GPT."
        ...
        "it" = @{
            ...
            "GptTranslateStart" = "Traduzione dei sottotitoli da $sourceLanguageName a $targetLanguageName avviata con GPT."
        ...
        "hy" = @{
            ...
            "GptTranslateStart" = "$sourceLanguageName-ից $targetLanguageName ենթավերնագրերի GPT-թարգմանությունը սկսվել է։"
        ...
        "as" = @{
            ...
            "GptTranslateStart" = "$sourceLanguageNameৰ পৰা $targetLanguageNameলৈ সাবটাইটেলসমূহৰ GPT অনুবাদ আৰম্ভ হৈছে।"
        ...
        "ba" = @{
            ...
            "GptTranslateStart" = "$sourceLanguageName-тан $targetLanguageName титрҙары GPT ярҙамында тәржемә ителә башланы."
        ...
        "bn" = @{
            ...
            "GptTranslateStart" = "$sourceLanguageName থেকে $targetLanguageName সাবটাইটেলের GPT অনুবাদ শুরু হয়েছে।"
        ...
        "bi" = @{
            ...
            "GptTranslateStart" = "Translating blong $sourceLanguageName to $targetLanguageName subtitles I stat wetem GPT."
        ...
        "br" = @{
            ...
            "GptTranslateStart" = "Kregiñ zo bet graet gant an droidigezh GPT a $sourceLanguageName da $targetLanguageName titloù."
        ...
        "ch" = @{
            ...
            "GptTranslateStart" = "I Sinchchonza GPT $sourceLanguageName para $targetLanguageName subtitulos na gaigeha."
        ...
        "ce" = @{
            ...
            "GptTranslateStart" = "$sourceLanguageName лахьан $targetLanguageName лаьттан GPT-да субтитрта тарад."
        ...
        "ny" = @{
            ...
            "GptTranslateStart" = "Chiyambi cha kumasulira kwa $sourceLanguageName kupita $targetLanguageName ma subtitles pogwiritsa ntchito GPT."
        ...
        "cv" = @{
            ...
            "GptTranslateStart" = "$sourceLanguageName тăсăртан $targetLanguageName çулислă GPT пурăн тарихни."
        ...
        "kw" = @{
            ...
            "GptTranslateStart" = "$sourceLanguageName a syncronised der $targetLanguageName subtitles dre GPT."
        ...
        "co" = @{
            ...
            "GptTranslateStart" = "A traduzzione di $sourceLanguageName in $targetLanguageName sottotituli hà iniziatu cù GPT."
        ...
        "cr" = @{
            ...
            "GptTranslateStart" = "$sourceLanguageName ᐃᑭᔭᐦᐄᑭᓇᐁᐧ ᐱᑳᓇᐁᐧᐠ ᐅᐱᓀᓱᓂᓂᑯᐃᐧ $targetLanguageName ᑯᒪ GPT"
